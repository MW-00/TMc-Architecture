...
const Contact = () => {
    return (
        <div>
            ...
            <div className="row">
                <div className="col p-0 ratio ratio-16x9" style={{ minHeight: "100px", width: "100%" }}>
                ...
                <div className="col-4 text-center align-items-center d-flex justify-content-center flex-column" style={{ minHeight: "100px" }}>
