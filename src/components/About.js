    ...
    return (
        <div>
            <div className="row mb-5">
                ...
                <div className="col-8">
                    <p>
                        <strong>TMC Architects is a forward thinking architectural-practice based in Jersey with a focus on designing buildings that make a positive impact to their surroundings.</strong><br/>   
